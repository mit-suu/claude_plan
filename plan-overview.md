...
| 4 | T20 | D | Đang làm | 2026-09-16 | DoD 4/4 trên mock. **Đã merge `develop`** (BE + FE, `30b9f19` / `fde920e`). 13 step Brief + 4 step S-1 qua step runner, ghi Spine bằng op; bỏ `CHAT_DISCOVERY`; FE hết suy state từ tin nhắn, thêm 3 panel Brief. BE 667 test xanh, FE 192 test xanh + lint sạch. **Còn: lượt chạy thật trên dev** |
| — | **M4** | cả 4 | [ ] | | |
| 5 | T21 | A | Chưa làm | | |
| 5 | T22 | B | Chưa làm | | |
| 5 | T23 | D | Chưa làm | | |
...
**Tiến độ wave:** W1 7/7 · W2 5/5 · W3 4/4 · W4 **4/4 đã merge `develop`** (T17, T19 xong; T18, T20 chờ lượt chạy thật) · W5 0/4 · **Tổng 19/24** · Merge point: **M1 [x]** · M2 [ ] · **M3 [x]** · M4 [ ] · M5 [ ].
