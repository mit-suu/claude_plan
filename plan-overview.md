...
| 3 | T14 | B | Xong | 2026-09-15 | DoD 4/4 — run18–20 GLM thật trên brief fixture bổ sung (`52f4772`): 6/21, 7/21, 6/20 actor/use case, 0 cờ đỏ §1/§2. Lịch sử: DoD 2/4. Đã bỏ `stub` (`fa94afc`), S-3.6 render lại `context` (`bc1d5c4`). Giữ GLM-5.3-Flash (`reasoning_effort: low` + `json_object`, `7618fe7`); siết skill + registry `reads` (`be189e2`). 6/6 lượt chạy thật trọn S-1.2→S-3.6→Word, 0 cờ đỏ §1/§2, 0 non-English. **Còn:** ngưỡng ≥ 5 actor / ≥ 12 use case chưa đạt ổn định (3–4 actor, 10–15 use case). Số đo: `docs/measurements.md` |
